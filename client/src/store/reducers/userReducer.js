...
//Reducer to handle user registration action
...
//Reducer to handle user details action
...
//Reducer to handle user delete action
...
//Reducer to handle user update action
